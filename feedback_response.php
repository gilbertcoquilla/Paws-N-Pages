...
<div class="container-fluid pt-5">
    <div class="container">
        <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
            ...
            <h3 class="display-8 text-uppercase mb-0">Your feedback has been submitted!</h3>
        </div>
            <h3></h3>
                <h5>We're really grateful and appreciate you taking the time to share your rating with us. 💙
                </h5>
    </div>
</div>
<!-- Feedback Status End -->

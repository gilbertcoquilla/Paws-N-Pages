            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        $ret = mysqli_query($con, "SELECT appointments.AppointmentID, appointments.Notes, appointments.PreferredDateTime, services.ServiceName, services.ServiceDescription, services.ServicePrice, clinics.ClinicName, users.Username FROM appointments INNER JOIN services ON appointments.ServiceID = services.ServiceID INNER JOIN clinics ON services.ClinicID = clinics.ClinicID INNER JOIN users ON appointments.UserID = users.UserID");
                        ...
                        ?>
                                ...
                                <tr>
                                    <td><?php echo $cnt; ?></td>
                                    <td><?php echo $row['PreferredDateTime'] ?></td>

...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO services (ServiceName, ServiceDescription, ServicePrice, ClinicID) VALUES ('$serviceName', '$serviceDescription', '$servicePrice', '$clinicID')");

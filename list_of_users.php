...
if (isset($_GET['delid'])) {
    ...
    $sql = mysqli_query($con, "DELETE FROM users WHERE UserID=$rid");
    echo "<script>alert('Record is deleted successfully');</script>";
    echo "<script>window.location.href = 'list_of_users.php'</script>";
}
?>
...
<head>
    <title>Paws N Pages User Records</title>
    <meta charset="utf-8">
    ...
    <div class="bgbody">
        <div class="container-fluid">
            <div class="table-container">
                ...
                <div>
                    <form action="list_of_pets_insert.php">

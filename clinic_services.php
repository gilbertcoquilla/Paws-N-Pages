...
if (isset($_GET['delid'])) {
    ...
    echo "<script>window.location.href = 'clinic_services.php'</script>";
}
?>
...
<head>
    <title>Paws N Pages Clinic's Services</title>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="clinic_services.php" class="nav-item nav-link active">Services</a>
    ...
    <div class="bgbody">
        <div class="container-fluid">
            <div class="table-container">
                <div class="student">
                    <h1>
                        Paws N Pages Clinic's Services
                    </h1>
                </div>
                <div>
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr class="table100-head">
                            ...
                            <th class="column1">Service Name</th>
                    ...
                    <tbody>
                        <?php
                        $ret = mysqli_query($con, "SELECT services.ServiceID, clinics.ClinicName, services.ServiceName, services.ServiceDescription, services.ServicePrice FROM services INNER JOIN clinics ON services.ClinicID = clinics.ClinicID");
                        $cnt = 1;
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="clinic_services_edit.php?editid=<?php echo htmlentities($row['ServiceID']); ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons" style="color:dodgerblue;">&#xE254;</i></a>
                                        <a href="clinic_services.php?delid=<?php echo ($row['ServiceID']); ?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Delete record?');"><i class="material-icons" style="color:firebrick;">&#xE872;</i></a>
                                    </td>
                                </tr>
                            <?php
                                $cnt = $cnt + 1;

        ...
        <div class="container-login100" style="background-image: url('images/gm1.jpg')">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                <form method="POST" enctype="multipart/form-data" runat="server">
                    ...
                    <?php
                    $eid = $_GET['editid'];
                    $ret = mysqli_query($con, "SELECT * FROM pets WHERE PetID='$eid'");
                    ...
                    ?>
                        ...
                        <div class="wrap-input100 validate-input m-b-23">
                            <p>Pet Name</p>
                            <input type="text" id="petName" name="petName" value="<?php echo $row['PetName'] ?>" required />
                            <br>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-23">
                            <p>Species</p>
                            <input type="text" id="species" name="species" value="<?php echo $row['Species'] ?>" />
                            <br>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-23">
                            <p>Breed</p>
                            <input type="text" id="breed" name="breed" value="<?php echo $row['Breed'] ?>" required />
                            <br>
                        </div>
